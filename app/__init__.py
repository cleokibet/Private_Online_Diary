...
app.config['MAIL_SUBJECT_PREFIX'] = '[Private_Online_Diary]'
app.config['MAIL_SENDER'] = 'Private_Online_Diary<admin@Private_Online_Diary.com>'
app.config['DEFAULT_NAME'] = 'Private_Online_Diary'
